...
[^1]: Siehe zum Beispiel: Hesse, Wolfgang: Die Glaubwürdigkeit der Wikipedia, in: Information - Wissenschaft & Praxis 69 (4), 2018, S. 171–181. Online: <https://doi.org/10.1515/iwp-2018-0015>.
...
- `imageData.xml` - In dieser XML-Datei sind alle Artikelversionen mit allen dort verzeichneten Bildern gespeichert.[^5]
...
[^7]: Siehe [Bildquellenauswertung des Artikels "Tiananmen Zwischenfall"](./Artikel/tiananmen/README.md).